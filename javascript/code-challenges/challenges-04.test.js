...
const sortNumbers = (arr) => {
  // Solution code here...
  const sortedNumbers = arr.sort(function(a, b) {return a - b;});
...
const sortBackwards = (arr) => {
  // Solution code here...
  const sortedNumbers = arr.sort(function(a, b) {return b - a;});
  return sortedNumbers;
};
...
const sortByPrice = (arr) => {
  // Solution code here...
  const price = arr.sort(function(a, b) {return a.price - b.price;});
  return price;
};
